// $Id: JChannel.java,v 1.1 2008/09/03 04:24:43 commerce\wuti7102 Exp $
...
public class JChannel extends Channel {
     ...
     *                   In case properties is a org.w 3 c.dom.Element, the ConfiguratorFactory will parse the
    ...
    public JChannel(Object properties) throws ChannelException {
        ...
        if(properties == null) {
            System.out.println("No properties defined... using defaults.");
        } else {
    ...
    class CloserThread extends Thread {
        ...
        public void run() {
            try {
                ...
                if(auto_getstate) {
                    boolean rc=getAllStates(null, GET_STATE_DEFAULT_TIMEOUT);
                    if(rc)
