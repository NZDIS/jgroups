// $Id: LOOPBACK.java,v 1.1 2008/09/03 04:24:40 commerce\wuti7102 Exp $
...
public class LOOPBACK extends Protocol {
    ...
    public LOOPBACK() {
      System.out.println("loopback has been run");
    }
    ...
    public void down(Event evt) {
        ...
        if(Trace.trace)
            Trace.info("LOOPBACK.down()", "event is " + evt + ", group_addr=" + group_addr +
