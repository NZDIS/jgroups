// $Id: VectorTime.java,v 1.1 2008/09/03 04:24:39 commerce\wuti7102 Exp $
...
public class VectorTime
{
   ...
   public VectorTime(Address owner)
   {
      this.owner = owner;
      entries = new TreeMap();
      entries.put(owner, new Integer(0));
   }
   ...
   public void increment()
   {
      ...
      entries.put(owner, new Integer(value.intValue() + 1));
   }
   ...
   public void max(TransportedVectorTime other)
   {
      ...
      while (iter.hasNext())
      {
         ...
         if (otherVectorValue > thisVectorValue)
            entries.put(member, new Integer(otherVectorValue));
      }
   ...
   private void intializeEntries(Collection c)
   {
      ...
      while (iter.hasNext())
      {
         ...
         entries.put(newMember, new Integer(0));
      }
   }
}
