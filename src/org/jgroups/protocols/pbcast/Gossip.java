// $Id: Gossip.java,v 1.1 2008/09/03 04:24:42 commerce\wuti7102 Exp $
...
public class Gossip implements Serializable {
	...
	sender=obj; this.id=id;
    }

    public Gossip(Address obj, long id, Digest d, Vector not_seen) {
	sender=obj; this.id=id; digest=d; this.not_seen=not_seen;
    }
    ...
    public Vector getNotSeenList() {return not_seen;}

    public Vector getSeenList() {return seen;}
